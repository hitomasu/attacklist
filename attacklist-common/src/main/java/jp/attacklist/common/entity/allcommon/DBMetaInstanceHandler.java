package jp.attacklist.common.entity.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "jp.attacklist.common.entity.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_SECURITY", "jp.attacklist.common.entity.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("TWEET", "jp.attacklist.common.entity.bsentity.dbmeta.TweetDbm");
